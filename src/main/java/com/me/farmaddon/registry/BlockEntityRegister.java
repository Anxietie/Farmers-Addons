...
public class BlockEntityRegister {
	public static final BlockEntityType<CropLabelBlockEntity> CROP_LABEL_BLOCK_ENTITY = FabricBlockEntityTypeBuilder.create(CropLabelBlockEntity::new, BlockRegister.getBlocks().toArray(new Block[0])).build();
